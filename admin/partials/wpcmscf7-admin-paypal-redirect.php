...
$enable = get_post_meta($post_id, "wpcmscf7_enable", true);
$name = get_post_meta($post_id, "wpcmscf7_name", true);
$price = get_post_meta($post_id, "wpcmscf7_price", true);
$id = get_post_meta($post_id, "wpcmscf7_id", true);
$email = get_post_meta($post_id, "wpcmscf7_email", true);
...
$return_url = (isset($value['return']) && !empty($value['return'])) ? $value['return'] : site_url();
$cancel_url = (isset($value['cancel']) && !empty($value['cancel'])) ? $value['cancel'] : site_url();

$ipn_url = plugin_dir_url( __FILE__ ).'ipn.php';
...
<body>
<form action='https://www.<?php echo $path; ?>.com/cgi-bin/webscr' method='post' name="wpcmscf7pp">
<input type='hidden' name='cmd' value='_xclick' />
<input type="hidden" id="trans-id" name="custom" value="<?php echo $this->last_insert_id; ?>">
...
<input type="hidden" id="paypal_notify_url" name="notify_url" value="<?php echo $ipn_url; ?>" />
</form>
<script type="text/javascript">
document.wpcmscf7pp.submit();
</script>
</body>
</html>